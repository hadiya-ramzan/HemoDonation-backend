...
-- Patch 10A: Phase 3 donor search SQL safe-update fix
-- Purpose: Same repair/diagnostics as Patch 10, but compatible with MySQL Workbench Safe Update Mode.
...
-- Also normalize blood group text.
UPDATE users
SET blood_group = UPPER(TRIM(blood_group))
